                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.apiResult0cb =
                                    ...
                                    phone: _model.telefonoTextController.text,
                                    address:
                                        _model.direccionTextController.text,
                                    municipality:
                                        _model.municipioTextController.text,
                                    departament:
                                        _model.departamentoTextController.text,
                                  );

                                  context.pushNamed('Inicio');

                                  if ((_model.apiResult0cb?.succeeded ??
                                      true)) {
                                    FFAppState().ShowData = getJsonField(
                                      (_model.apiResult0cb?.jsonBody ?? ''),
                                      r'''$''',
                                      true,
                                    )!
                                        .toList()

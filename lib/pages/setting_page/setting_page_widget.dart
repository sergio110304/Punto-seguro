                                    ...
                                    onTap: () async {
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            content: const Text(
                                                'Comuniquese con el administrador de la aplicación.'),
                                            actions: [
                                              TextButton(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        context.pushNamed('HomePageOption');
                                      },
                                      text: 'Cerrar Sesión',
                                      options: FFButtonOptions(
                                        ...
                                        iconPadding:
                                            const EdgeInsetsDirectional.fromSTEB(
                                                0.0, 0.0, 0.0, 0.0),
                                        color: const Color(0xFFDD3B44),
                                        textStyle: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily: 'Inter',
                                              color: const Color(0xFFA4A9AB),
                                              letterSpacing: 0.0,
